...
class TestDoublyLinkedList(unittest.TestCase):
    ...
    def test_iterator_for_a_doubly_linked_list(self):
        """
    ...
    def test_reverse_a_doubly_linked_list(self):
        """ This test ensures that the collection can be reversed """
        iterator = reversed(self._linked_list)
